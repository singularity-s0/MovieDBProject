...
std::map<boost::json::string, bool> manager_perms = boost::assign::map_list_of ("modify_announcement", true) ("modify_movie", true) ("view_user", true) ("modify_user", true);
std::map<boost::json::string, bool> admin_perms = boost::assign::map_list_of ("modify_announcement", true) ("modify_movie", true) ("view_user", true) ("modify_user", true);
